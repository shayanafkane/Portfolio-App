...
function Header() {
    ...
    return (
        ...
        <Stack>
            <Circle position="absolute" bg="blue.100" opacity="0.1" w="400px" h="400px" alignSelf="flex-end" />
            <Flex direction={isNotSmallerScreen ? "row" : "column"} spacing="200px" p={isNotSmallerScreen ? "32" : "0"} >
                ...
                <Image alignSelf="center" mt={isNotSmallerScreen ? "0" : "12"} mb={isNotSmallerScreen ? "0" : "12"}
                    ...
                    boxSize="400px" src='https://res.cloudinary.com/dpzrxnav1/image/upload/v1641201468/test/ezgif.com-gif-maker_11_pznwag.jpg' />
            </Flex>
        </Stack>
    )
}
